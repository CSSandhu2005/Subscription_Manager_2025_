        ...
        <footer className="border-b bg-white pt-20 dark:bg-transparent">
            <div className="mb-8 border-b md:mb-12">
                <div className="mx-auto flex max-w-5xl flex-wrap items-end justify-between gap-6 px-6 pb-6">
                    <Link
                        ...
                        <h1 className="text-3xl font-semibold">Subscription Manager</h1>
                    </Link>
            ...
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="mt-12 flex flex-wrap items-end justify-between gap-6 border-t py-6">
                    <small className="text-muted-foreground order-last block text-center text-sm md:order-first">© {new Date().getFullYear()} Subscription Manager, All rights reserved</small>
